...
<SectionWrapper>
    ...
    >
        <h2
            class="text-5xl sm:text-6xl md:text-7xl max-w-[1200px] mx-auto w-full text-center font-semibold"
        >
            <span class="text-indigo-400">Gym</span> Training
            <span class="text-slate-600 line-through">Is Hard</span><br />Just
            Got <span class="text-indigo-400">Easier</span>
        </h2>
        <p
            class="text-xl sm:text-2xl md:text-3xl text-center max-w-[1000xp] mx-auto w-full"
        >
        ...
        <div class="flex items-center justify-center gap-2 text-base">
            ...
            {#each [0, 1, 2, 3, 4] as index}
                <div class="grid place-items-center relative">
                    ...
                    <div
                        class={"absolute top-0 left-0 grid place-tems-center " +
