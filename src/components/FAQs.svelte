...
<SectionWrapper id="faqs">
    <div class="flex-flex-col gap-10 sm:gap-14 md:gap-24 py-20 flex-1 items-center justify-center">
        <div class="flex flex-col gap-2">
            <p class="opacity-60 text-based sm:text-lg md:text-xl text-center">For all your questions, qualms, and queries</p>
            <h3 class="text-4xl sm:text-5xl md:text-6xl max-w-[1000px] mx-auto w-full font-semibold text-center"
            >See what Frequently Asked Questions</h3>
        </div>
        <div class="flex flex-col gap-8 sm:gap-10 md:gap-14 w-full mt-10">
            {#each faqs as faq}
