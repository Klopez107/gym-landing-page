...
<div
    class="grid grid-cols-1 md:grid-cols-2 gap-14 lg:gap-20 relative text-base"
>
    <div class={"flex flex-col gap-8 md:gap-10 pt-8 sm:pt-10 " + (index % 2 === 1 ? "md:order-2" : " ")}>
        ...
        <p class="pt-10">{productFeature.description}</p>
    ...
    >
        <div
            class="rounded-top-xl h-8 sm:h-10 bg-white opacity-60 px-3 flex items-center gap-2"
        >
            {#each [1, 2, 3] as i}
                <div
