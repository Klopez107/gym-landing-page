...
<SectionWrapper>
    <div class="flex-flex-col gap-10 sm:gap-14 md:gap-24 py-20 flex-1 items-center justify-center">
        <div class="flex flex-col gap-2">
            ...
            >See what <span class="text-indigo-400">Others</span> have to say</h3>
        </div>
        <div class="flex flex-col md:flex-row gap-8 w-fit mx-auto mt-3">
        ...
        <div class="flex flex-col items-center my-4">
            <button on:click={() => lim = !lim}
                class="specialBtn my-3">
                <p>{lim ? 'Show More' : 'Show Less'}</p>
            </button>
            <div class="flex flex-col gap-10 mt-3">
                <p class="mx-auto text-lg sm:text-xl md:text-2xl font-semibold">Trusted by 1,423 Swoldiers</p>
                <Stars />
            </div>
        </div>
